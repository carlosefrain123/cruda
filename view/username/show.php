...
<div class="pb-3">
    ...
    <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">Elminar</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">¿Desea eliminar un registro?</h1>
